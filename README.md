...
curl -s -X POST -d 'x' http://localhost:3000/boton -o prueba.png  //hay que cambiar la x por el numero del botón
# ver la pantalla actual sin pulsar:
curl -s http://localhost:3000/captura.png -o actual.png
